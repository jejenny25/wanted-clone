...
const SectionGrowth = () => {
    ...
    const article_settings = {
        ...
        // Navigation arrows
        navigation: {
            nextEl: '.growth-button-next',
            prevEl: '.growth-button-prev',
        },
    };
    ...
    <SectionGrowthStyled>
        <InnerStyled>
            <div className="tit-wrap">
                <p className="tit">
                    <Link to="#" className="tit-tag-link">#급성장 중 <span className="img"><img src="images/ico-growth.png" alt="" /></span></Link>
                    회사들을 모아봤어요
                </p>
                <Link to="#" className="tit-link">포지션으로 더 보기<IcoArr5 /></Link>
                <button type="button" className="growth-button-prev"><span className="ico"><IcoArr5 /></span></button>
                <button type="button" className="growth-button-next"><span className="ico"><IcoArr5 /></span></button>
            </div>
            <ComsListStyled>
...
const SectionGrowthStyled = styled.div`
    position:relative;
    margin-bottom:90px;
    ...
    .growth-button-next,
    .growth-button-prev {display:flex; align-items:center; justify-content:center; position: absolute; z-index:10; top: 50%; margin-top: -18px; width: 36px; height: 36px; left:0; border: 1px solid #e1e2e3; border-radius: 50%; background-color: #fff; box-shadow: 0 2px 2px 0 rgb(0 0 0 / 5%);} 
    .growth-button-next {left:inherit; right:0;}
    .growth-button-prev.swiper-button-disabled,
    .growth-button-next.swiper-button-disabled {opacity:.35}
    .growth-button-next .ico,
    .growth-button-prev .ico {display:inline-block; width:16px; height:16px; color: #767676; fill:#767676;} 
    .growth-button-prev .ico {transform:rotate(180deg);}
    .growth-button-next:after,
    .growth-button-prev:after {content:'';}
`;
